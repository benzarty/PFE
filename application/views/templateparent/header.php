...
<div class="wrapper boxed-wrapper">
	<header class="main-header">
		<!-- Logo -->
		<a href="<?php echo base_url('Admin/Seeyourchildren/'.$user->id);?>" class="logo" style="background-color: #0E7AC4">
		...
		<!-- Header Navbar -->
		<nav class="navbar blue-bg navbar-static-top" style="background-color:#0E7AC4 ">
			...
			<div class="navbar-custom-menu">
				<ul class="nav navbar-nav">
					...
					<?php			 if ($messagenotifm==1) { ?>
							...
							<li class="footer"><a href="<?php echo base_url('Admin/Consultationmailparent/'.$user->id);?>">View All Messages</a></li>
						</ul>
					</li>
					<!-- Notifications  -->
 ...
 <?php if( $blog->title == 'Note') { ?>
											<div class="pull-left icon-circle green"><i class="icon-bag"></i></div>  <?php } ?>
...
<?php if( $blog->title == 'Annonce') { ?>
							...
							<li class="footer"><a href="<?php echo base_url('Admin/MarkreadNotifParent');?>">Check all Notifications</a></li>
						</ul>
					</li>
					<!-- User Account  -->
					<li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php echo site_url().'uploads/'.$user->image?>" class="user-image" alt="User Image"> <span class="hidden-xs"><?php echo $user->firstName; ?> <?php echo $user->lastName ; ?></span> </a>
						<ul class="dropdown-menu">
							<li style="background-color: #0E7AC4" class="user-header">
							...
							<li><a href="<?php echo base_url('Admin/profilparent');?>"><i class="icon-profile-male"></i> My Profile</a></li>
							<li><a href="<?php echo base_url('Admin/Consultationmailparent/'.$user->id);?>"><i class="icon-envelope"></i> Inbox</a></li>
	...
	<aside class="main-sidebar">
		...
		<div class="sidebar">
			...
			<ul class="sidebar-menu" data-widget="tree">
				<li> <a href="<?php echo base_url('Admin/Seeyourchildren/'.$user->id);?>"> <i class="icon-home"></i> <span>Children view </span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
				...
				<li class="treeview"> <a href="#"> <i class="ti-email"></i> <span>Inbox</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
					<ul class="treeview-menu">
							<li><a href="<?php echo base_url('Admin/Consultationmailparent/'.$user->id);?>"><i class="fa fa-angle-right"></i> Consultation</a></li>
						<li><a href="<?php echo base_url('Admin/ajoutmailparent');?>"><i class="fa fa-angle-right"></i> Write</a></li>
					</ul>
				</li>
				...
				<li> <a href="<?php echo base_url('Admin/upcoming');?>"><i class="ti-announcement"></i> <span>View Announcement </span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>

				</li>
				<li> <a href="<?php echo base_url('Admin/SeeConvocation/'.$user->id);?>"><i class="icon-call-out"></i> <span>View Convocation </span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
