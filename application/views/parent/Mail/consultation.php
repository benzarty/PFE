<div class="content-wrapper">
	...
	<div class="content">
		<div class="row">
			<div class="col-lg-2"> <a href="<?php echo base_url('Admin/ajoutmailparent');?>" class="btn btn-danger btn-block margin-bottom">Compose</a>
      ...
      <tr>
		  ...
		  <th>Date</th>
								...
								<tr>
									...
									<td><a type="button" class="btn btn-outline-secondary" href="<?php echo base_url('Admin/detailmailparent/'.$blog->id);?>"> See Message</a></td>
