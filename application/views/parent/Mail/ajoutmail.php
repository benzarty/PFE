<div class="content-wrapper">
	...
	<!-- Main content -->
	<div class="content">
		<?php echo form_open('Admin/saveparentmail'); ?>
			...
			<div class="col-lg-12">
				<div class="box box-primary">
					...
					-->
                      ...
                      <select class="form-group custom-select" name="idparent" id="name2" required>
                      	<option selected disabled >Select Adress......</option>
                      	<?php 
