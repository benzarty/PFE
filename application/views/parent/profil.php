						...
						<div class="row">
							...
							<div class="col-lg-8 offset-2">
								<div class="card text-white bg-secondary mb-3">
									<form method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/Profilsettingparent')?>">
										...
										<div class="card-body">
											<div class="card-body">
												...
												<div class="text-center">	<button type="submit" name="submit" class="btn btn-success"><i class="fa fa-check"></i>Save Data </button></div>
