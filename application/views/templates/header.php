...
<head>
	...
	<title>Garden School Application</title>
...
<div class="wrapper boxed-wrapper">
	<header class="main-header">
		<!-- Logo -->
		<a href="<?php echo base_url('Admin/indexadmin');?>" class="logo" style="background-color: red">
		...
		<!-- Header Navbar -->
		<nav class="navbar blue-bg navbar-static-top" style="background-color: red">
			...
			<div class="navbar-custom-menu">
				<ul class="nav navbar-nav">
					...
					<?php			 if ($messagenotifm==1) { ?>
							...
							<li class="footer"><a href="<?php echo base_url('Admin/Consultationmail/'.$user->id);?>">View All Messages</a></li>
						</ul>
					</li>
					<!-- Notifications  -->
    ...
    <?php if( $blog->title == 'Announcement') { ?>
						...
						<?php if( $blog->title == 'Convocation') { ?>
							...
							<li class="footer"><a href="<?php echo base_url('Admin/MarkreadNotifAdmin');?>">Check all Notifications</a></li>
						</ul>
					</li>
					<!-- User Account  -->
					<li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php echo site_url().'uploads/'.$user->image?>" class="user-image" alt="User Image"> <span class="hidden-xs"><?php echo $user->firstName; ?> <?php echo $user->lastName ; ?></span> </a>
						<ul class="dropdown-menu">
							<li style="background-color: red" class="user-header">
							...
							<li><a href="<?php echo base_url('Admin/Consultationmail/'.$user->id);?>"><i class="icon-envelope"></i> Inbox</a></li>
			...
			<ul class="sidebar-menu" data-widget="tree">
				<li class="active treeview"> <a href="#"> <i class="icon-home"></i> <span>Management Operation</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
					<ul class="treeview-menu">
						...
						<li><a href="<?php echo base_url('Admin/teacher1');?>"><i class="fa fa-angle-right"></i> Teacher</a></li>
						<li><a href="<?php echo base_url('Admin/modifierclasse');?>"><i class="fa fa-angle-right"></i> Class</a></li>
				...
				<li class="treeview"> <a href="#"> <i class="ti-email"></i> <span>Inbox</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
					<ul class="treeview-menu">
						<li><a href="<?php echo base_url('Admin/Consultationmail/'.$user->id);?>"><i class="fa fa-angle-right"></i> Consultation</a></li>
				...
				<li> <a href="<?php echo base_url('Admin/ConvocationRequest/');?>" > <i class="icon-call-out"></i> <span>Convocation Requests</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
