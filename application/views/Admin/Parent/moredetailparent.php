<div class="content-wrapper">
	...
	<div class="content">
		...
		<h4 class="text-black">Students in this class :</h4>
			...
			<table id="table_etudiantparparent" class="table table-striped table-bordered table-responsive" width="100%">
				<thead>
				<tr>
					...
					<div class="modal-dialog">
						...
						<form  method="post" enctype="multipart/form-data">
												...
												<table class="table">
													...
													foreach ($requests as $req) {
														...
														<tr>
															...
															<td style="text-align: center"><input type="checkbox" class="ajoutp_checkbox " value="<?php echo $req->id; ?>"></td>
								...
								<div class="modal-footer">
									<button   name="affectationeleveparent" id="affectationeleveparent" class="btn btn-rounded btn-outline-secondary"><i class="icon-plus"> Add</i></button>
